...
export default function X402Page() {
  return (
    <>
      ...
      <div className="space-y-4 leading-relaxed text-[var(--ribbon-soft)]">
        <p>
          The flow is: a server answers <code className="font-mono text-[var(--ribbon)]">402</code> with
          what it wants paid, the client signs an EIP-3009 authorisation into an{" "}
          <code className="font-mono text-[var(--ribbon)]">X-PAYMENT</code> header, and a facilitator
          submits it and reports back. The report carries{" "}
          <code className="font-mono text-[var(--ribbon)]">success: true</code> and a transaction hash.
        </p>
        <p className="text-[var(--ribbon)]">
        ...
        <p>
          A settlement that mined with <code className="font-mono text-[var(--ribbon)]">status: 0x1</code>,
          emitted no <code className="font-mono text-[var(--ribbon)]">Transfer</code>, and moved nothing
      ...
      <p className="mt-2 text-sm leading-relaxed text-[var(--ribbon-soft)]">
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2">
                <Icon className={`size-4 ${good ? "text-[var(--ribbon)]" : "text-[var(--ribbon-red)]"}`} />
                <h3 className="font-medium tracking-tight">{r.title}</h3>
              </div>

              <dl className="mt-4 grid gap-2 font-mono text-xs sm:grid-cols-[130px_1fr]">
                <dt className="text-[var(--ribbon-soft)]">facilitator says</dt>
                <dd>{r.says}</dd>
                <dt className="text-[var(--ribbon-soft)]">chain says</dt>
                <dd className={good ? "" : "text-[var(--ribbon-red)]"}>{r.chain}</dd>
                <dt className="text-[var(--ribbon-soft)]">result</dt>
              ...
              <a
                ...
                target="_blank"
                rel="noopener"
                className="mt-4 inline-block font-mono text-xs text-[var(--ribbon-soft)] underline-offset-4 hover:text-[var(--ribbon)] hover:underline"
              >
      ...
      <pre className="mt-4 overflow-x-auto rounded-[2px] border border-[var(--perf)] bg-[var(--stock-edge)] p-5 font-mono text-xs leading-relaxed text-[var(--ribbon)]">
...
return serve(resource);`}
      ...
      <p className="mt-4 text-sm leading-relaxed text-[var(--ribbon-soft)]">
      ...
      <div className="mt-10 rounded-[2px] border border-[var(--perf)] bg-[var(--stock-edge)] p-5">
