      ...
      <form onSubmit={submit} className="mt-8 space-y-4">
        <div className="space-y-2">
          ...
          {errors.transactionHash && (
            <p id="hash-error" className="text-xs text-[var(--refused)]">{errors.transactionHash}</p>
          )}
        ...
        <div className="space-y-2">
          ...
          />
          {errors.token ? (
            <p id="token-error" className="text-xs text-[var(--refused)]">{errors.token}</p>
          ) : (
            <p className="text-xs text-[var(--ink-3)]">
        ...
        <div className="grid gap-4 sm:grid-cols-[1fr_200px]">
          <div className="space-y-2">
            ...
            />
            {errors.recipient && (
              <p id="to-error" className="text-xs text-[var(--refused)]">{errors.recipient}</p>
            )}
          </div>
          <div className="space-y-2">
            ...
            />
            {errors.minAmount && (
              <p id="amt-error" className="text-xs text-[var(--refused)]">{errors.minAmount}</p>
            )}
          </div>
        </div>
      ...
      {result && (
        <div className="mt-6 space-y-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            className="inline-block font-mono text-xs text-[var(--ink-3)] underline-offset-4 hover:text-[var(--ink)] hover:underline"
          >
