...
import { activePolicy, now, validIntent } from "./helpers.ts";
...
class InMemoryLedger implements Ledger {
  ...
  // --experimental-strip-types cannot parse the shorthand, and this suite runs
  // under type-stripping rather than a compiler.
